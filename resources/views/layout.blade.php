  ...
  <div class="container">
    <header>
      ...
      <div class="header_links_container">
        <ul class="list-inline">
          ...
          <li>
            <button class="black_link" disabled="disabled"><strong>Do kasy</strong></button>
          </li>
        </ul>
    ...
    <nav class="navbar_nav">
      ...
      <ul class="list-inline">
        ...
        <li class="nav_pic underline">
          <a href="#"><img src="images/fac.png" alt="facebook_site"></a>
        </li>
        <li class="nav_pic underline">
          <a href="#"><img src="images/ins.jpg" slt=instagram_site></a>
        </li>
        <li class="underline nav_pic">
    ...
    <div class="row">
      ...
      <a class="main_page_section_title" href="">nowości</a> @yield('content')
      ...
      <footer>
        <div class="row newsletter">
          ...
          <div class="newsletter_button col-md-4 col-lg-3 col-sm-4 col-xs-12">
            <button class="black_link">Zapisz się ></button>
